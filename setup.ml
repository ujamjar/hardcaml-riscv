...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6a074f76b538cdae5c044a1bcf821d5c) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "testbench.ml"});
               Executable
                 ({
                     cs_name = "rv32tb";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "genpicorv32.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "j]\164\150\025\148\254\243[k\137E\239W.\127";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
