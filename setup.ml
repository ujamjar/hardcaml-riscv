...
(* OASIS_START *)
(* DO NOT EDIT (digest: 98deaa299c07798aad8635ed23a53e72) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-riscv";
          synopsis = "HardCaml RISC-V cores";
          description = Some [OASISText.Para "HardCaml RISC-V cores"];
          categories = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("hardcaml", None);
                           FindlibPackage ("hardcaml.syntax", None);
                           FindlibPackage ("hardcaml-waveterm.lterm", None);
                           FindlibPackage ("riscv", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "hardcaml-riscv";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "HardCamlAltera";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Pll"; "Vjtag_mm"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hardcaml-altera";
                      lib_findlib_containers = []
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the testbenches";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the core generators";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build apps requiring hardcaml-bloop";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
                     cs_name = "tesbench_picorv32";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "testbenches", true)
                        ];
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("hardcaml-llvmsim", None);
                           InternalLibrary "HardCamlRiscV";
                           FindlibPackage ("hardcaml-waveterm.lterm", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "testbench_picorv32.ml"
                   });
               Executable
                 ({
                     cs_name = "testbench_rv32";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "testbench_rv32.ml"});
               Executable
                 ({
                     cs_name = "testbench_cache";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "testbench_cache.ml"});
               Executable
                 ({
                     cs_name = "gen_picorv32";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "generators", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "HardCamlRiscV"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "gen_picorv32.ml"});
               Executable
                 ({
                     cs_name = "gen_rv32i";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "gen_rv32i.ml"});
               Executable
                 ({
                     cs_name = "instr_trap_sat";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "HardCamlRiscV";
                           FindlibPackage ("hardcaml-bloop", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = true; exec_main_is = "instr_trap_sat.ml"});
               Executable
                 ({
                     cs_name = "imm_encoding";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "imm_encoding.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml-riscv.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/hardcaml-riscv";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\147\137\209N\249\199\172|\128\174\rWb\206\145\015";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
